...
func main() {
	...
	r.Get("/api/companies/lookup-inn", companyH.LookupINN)
	r.Get("/api/companies/{companyID}/reviews", reviewH.ListReviews)
	r.Get("/api/analytics/market", analyticsH.GetMarketAnalytics)
	...
	r.Group(func(r chi.Router) {
		...
		r.Post("/api/products/import", productH.ImportProducts)
		r.Get("/api/products/export", productH.ExportProducts)
